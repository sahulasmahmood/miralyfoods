...
export const generateInvoiceHTML = async (order: any) => {
  ...
  if (!settings) {
    settings = {
      ...
      contactEmail: "miracmartcare@gmail.com",
      contactPhone: "+91 8754744204",
      address: "177/2, Kaligoundanur, Vellar Post, Mettur Taluk, Salem District - 636451",
      logo: "",
    };
  }
  ...
  const address = settings.address || "177/2, Kaligoundanur, Vellar Post, Mettur Taluk, Salem District - 636451";
  const addressLine1 = address.split(",").slice(0, 2).join(",");
  const addressLine2 = address.split(",").slice(2).join(",");
  const contactPhone = settings.contactPhone || "+91 8754744204";
  const contactEmail = settings.contactEmail || "miracmartcare@gmail.com";
    ...
    <body>
      <div class="page">
        ...
        <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:28px;padding-bottom:20px;border-bottom:1px solid #e5e7eb;">
          <div>
            ${logoHtml}
            <div style="font-size:30px;font-weight:700;color:#007D71;font-family:Georgia,serif;margin-bottom:4px;">${shopNamePart1}</div>
        ...
        <div style="display:flex;justify-content:flex-end;margin-bottom:24px;">
          <div style="width:280px;">
            ...
            ${taxRow}
            ${discountRow}
            <div style="display:flex;justify-content:space-between;align-items:center;border-top:2px solid #f3f4f6;margin-top:8px;padding-top:16px;font-size:20px;font-weight:700;color:#007D71;">
