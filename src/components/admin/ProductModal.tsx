                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#C4743F]/30 transition-all font-bold text-[#007D71] appearance-none cursor-pointer"
                        >
                              ...
                              <div className="flex gap-4 pl-8 animate-in slide-in-from-top-2 fade-in duration-300">
                                <div className="flex-1">
                                  ...
                                  <input
                                    ...
                                    className="w-full bg-[#EEEEEE] border-none rounded-xl py-3 px-4 text-sm font-bold text-[#007D71] outline-none focus:ring-2 focus:ring-[#C4743F]/30"
                                  />
                                </div>
                ...
                <div className="bg-[#F5F5F5] rounded-[32px] p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-white border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#C4743F]/30 transition-all font-medium text-[#007D71] placeholder:text-gray-300 resize-none h-full"
