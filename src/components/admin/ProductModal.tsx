      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="absolute inset-0 bg-[#B71C1C]/80 backdrop-blur-sm"
          />
          <motion.div
          ...
          >
            <div className="p-8 border-b border-gray-100 flex justify-between items-center bg-[#F5F5F5]">
              <div>
                <h2 className="text-3xl font-serif font-black text-[#B71C1C]">
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                  <h3 className="text-sm font-black uppercase tracking-widest text-[#B71C1C] border-b border-[#B71C1C]/10 pb-2">
                    Product Information
                  </h3>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#2E7D32]/30 transition-all font-bold text-[#B71C1C] placeholder:text-gray-300"
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#2E7D32]/30 transition-all font-medium text-[#B71C1C] placeholder:text-gray-300 resize-none"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#2E7D32]/30 transition-all font-bold text-[#B71C1C] appearance-none cursor-pointer"
                        >
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#2E7D32]/30 transition-all font-bold text-[#B71C1C]"
                    ...
                    <div className="flex flex-col justify-end gap-3 pb-2">
                      <label className="flex items-center gap-3 cursor-pointer group p-2 rounded-xl hover:bg-[#F5F5F5] transition-colors">
                        <div
                          className={`w-5 h-5 rounded-md border-2 flex items-center justify-center transition-all ${formData.isFeatured ? "bg-[#2E7D32] border-[#2E7D32]" : "border-gray-300 group-hover:border-[#2E7D32]"}`}
                        >
                          {formData.isFeatured && (
                        ...
                        />
                        <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider group-hover:text-[#B71C1C] transition-colors">
                          Featured
                        </span>
                      </label>
                    </div>
                  ...
                  <div className="space-y-4 pt-4">
                    <div className="flex justify-between items-center">
                      ...
                      {uploading && (
                        <span className="text-xs text-[#2E7D32] font-bold animate-pulse">
                          Uploading...
                        </span>
                      )}
                    </div>
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      ...
                      {formData.images.length < 4 && (
                        <div className="flex flex-col gap-2">
                          <label className="aspect-square border-2 border-dashed border-gray-200 hover:border-[#2E7D32] rounded-2xl flex flex-col items-center justify-center text-center cursor-pointer bg-[#F5F5F5] hover:bg-[#F5F5F5]/50 transition-all group">
                            <div className="w-10 h-10 bg-white rounded-full shadow-sm flex items-center justify-center text-gray-300 group-hover:text-[#2E7D32] group-hover:scale-110 transition-all mb-2">
                              <Upload size={16} />
                            </div>
                            <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest group-hover:text-[#2E7D32]">
                              Add Image
                            </span>
                            <input
                              type="file"
                    ...
                    {dataLoading ? (
                      ...
                      uoms.map((uom) => {
                        ...
                        return (
                          <div
                            key={uom._id}
                            className={`p-5 rounded-2xl transition-all border-2 ${isChecked ? "bg-white border-[#2E7D32] shadow-xl shadow-[#2E7D32]/5 scale-[1.02]" : "bg-transparent border-transparent hover:bg-white/50 hover:border-gray-200"}`}
                          >
                            <div className="flex items-center gap-4 mb-4">
                              <label className="flex items-center gap-3 cursor-pointer flex-grow">
                                <div
                                  className={`w-5 h-5 rounded-md border-2 flex items-center justify-center transition-all ${isChecked ? "bg-[#2E7D32] border-[#2E7D32]" : "bg-white border-gray-300"}`}
                                >
                                  {isChecked && (
                                    <Check size={12} className="text-white" />
                                  )}
                                ...
                                />
                                <span
                                  className={`text-sm font-bold uppercase tracking-wider ${isChecked ? "text-[#B71C1C]" : "text-gray-400"}`}
                                >
                                  {uom.name}
                                </span>
                              </label>
                              ...
                              <div className="flex gap-4 pl-8 animate-in slide-in-from-top-2 fade-in duration-300">
                                <div className="flex-1">
                                  ...
                                  <input
                                    ...
                                    className="w-full bg-[#EEEEEE] border-none rounded-xl py-3 px-4 text-sm font-bold text-[#B71C1C] outline-none focus:ring-2 focus:ring-[#2E7D32]/30"
                                  />
                                </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-100">
                <h3 className="text-sm font-black uppercase tracking-widest text-[#2E7D32] mb-6">
                ...
                <div className="bg-[#F5F5F5] rounded-[32px] p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full bg-white border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#2E7D32]/30 transition-all font-bold text-[#B71C1C] placeholder:text-gray-300"
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full bg-white border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#2E7D32]/30 transition-all font-medium text-[#B71C1C] placeholder:text-gray-300"
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-white border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#2E7D32]/30 transition-all font-medium text-[#B71C1C] placeholder:text-gray-300 resize-none h-full"
            ...
            <div className="p-8 border-t border-gray-100 bg-white flex justify-end gap-4 z-20">
              <button
                onClick={onClose}
                className="px-8 py-4 rounded-2xl font-black text-gray-300 hover:bg-gray-50 hover:text-[#B71C1C] transition-all uppercase tracking-widest text-[10px]"
              >
                Cancel
              </button>
              <button
                ...
                className="px-10 py-4 bg-[#B71C1C] text-white rounded-2xl font-black shadow-xl hover:bg-[#B71C1C] transition-all active:scale-95 disabled:opacity-70 flex items-center gap-2 uppercase tracking-widest text-[10px]"
              >
                {(loading || uploading) && (
