          ...
          >
            ...
            <p className="text-xl text-gray-500 leading-relaxed font-medium">
              {aboutUs.heroDescription ||
                "At Miraly Foods, we believe that food is more than just sustenance; it's a legacy. Founded on the principles of authenticity and purity, we bring the timeless recipes of our grandmothers' kitchens to your doorstep."}
            </p>
          </motion.div>
          <motion.div
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="text-lg text-gray-500 leading-relaxed font-medium mb-10">
            {aboutUs.journeyDescription ||
              "Miraly Foods started as a small kitchen experiment by a family of food enthusiasts who couldn't find the authentic taste of home in store-bought products. Today, we've grown into a community of thousands who share the same love for traditional South Indian delicacies."}
          </p>
