                ...
                <div className="space-y-4 mb-6">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="bg-[#007D71] text-white p-3 rounded-xl shadow-lg active:scale-95 flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#025D53] transition-colors"
                    >
              ...
              <div className="bg-white p-6 rounded-[24px] shadow-sm border border-gray-100">
                ...
                <div className="flex gap-2 mb-4">
                  ...
                  <button
                    ...
                    className="bg-[#C4743F] text-white p-3 rounded-xl shadow-lg active:scale-95 flex-shrink-0 disabled:opacity-40 hover:bg-[#025D53] transition-colors"
                  >
                    <Plus size={20} />
                  </button>
                </div>
                    ...
                    {pool.map((name) => (
                      <motion.button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all border ${
                          mapName === name
                            ? "bg-[#007D71] text-white border-[#007D71] shadow-md ring-2 ring-[#007D71]/10"
                            : "bg-gray-50 text-[#007D71] border-gray-200 hover:border-[#007D71]/30"
                        }`}
                      >
                        {name}
                        <span
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-xl bg-gray-50 border border-gray-100 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      {mapName ? (
                        <span className="text-xs font-black text-[#007D71] bg-[#C4743F]/15 px-3 py-1 rounded-lg border border-[#C4743F]/20">{mapName}</span>
                      ) : (
                  ...
                  <button
                    ...
                    className="w-full bg-[#C4743F] text-white py-4 rounded-xl hover:bg-[#025D53] transition-all shadow-lg active:scale-95 font-black uppercase tracking-widest text-xs disabled:opacity-40 disabled:scale-100 flex items-center justify-center gap-2"
                  >
                      ...
                      return (
                        <div key={cat._id} className="animate-in fade-in slide-in-from-top-2 duration-300">
                          <div className="flex items-center gap-2 mb-3 bg-gray-50/80 p-2 rounded-lg border border-gray-100">
                            ...
                            <span className="text-[9px] font-bold bg-[#C4743F] text-white px-2 py-0.5 rounded-full ml-auto">{subs.length} items</span>
                          </div>
          ...
          <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} onClick={(e) => e.stopPropagation()} className="bg-white rounded-[32px] p-8 w-full max-w-2xl max-h-[90vh] overflow-y-auto overscroll-contain shadow-2xl custom-scrollbar relative">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button onClick={onSave} className="flex-1 bg-[#007D71] text-white py-4 rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-[#025D53] shadow-lg transition-colors flex items-center justify-center gap-2"><Save size={16} /> Update Changes</button>
              </div>
            </div>
          </motion.div>
        </motion.div>
