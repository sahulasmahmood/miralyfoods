      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6 bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] border border-gray-100 shadow-sm mb-8">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-3xl lg:text-4xl font-serif font-black text-[#B71C1C] leading-none">
            Stock <span className="text-[#2E7D32] italic">Control</span>
          </h1>
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="bg-white rounded-[1.5rem] sm:rounded-[2rem] p-8 sm:p-12 text-center border-2 border-dashed border-gray-100">
            ...
            <h3 className="text-lg sm:text-xl font-serif font-bold text-[#B71C1C] mb-2">
              No Items Found
            </h3>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-grow min-w-0 text-center md:text-left">
                    <h3 className="font-bold text-[#B71C1C] text-base sm:text-lg leading-tight group-hover:text-[#2E7D32] transition-colors truncate">
                      {p.name}
                    </h3>
                  ...
                  <div className="flex flex-row md:flex-row items-center gap-4 sm:gap-8 md:gap-12 w-full md:w-auto justify-between md:justify-end shrink-0 border-t md:border-t-0 border-gray-50 pt-3 md:pt-0">
                    ...
                    <div className="bg-[#FAF3E0] p-2.5 sm:p-3 rounded-xl text-[#2E7D32] sm:opacity-0 sm:group-hover:opacity-100 transform sm:translate-x-4 sm:group-hover:translate-x-0 transition-all active:scale-90">
        ...
        {selectedProduct && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="absolute inset-0 bg-[#B71C1C]/60 backdrop-blur-sm"
            />
            ...
            >
              ...
              <div className="px-6 sm:px-10 py-6 border-b border-gray-100 flex justify-between items-center bg-[#F5F5F5]/50">
                <div className="min-w-0 pr-4">
                  <h2 className="text-xl sm:text-3xl font-serif font-black text-[#B71C1C] leading-tight truncate">
                    {selectedProduct.name}
                  </h2>
                  <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mt-1.5 flex items-center gap-2">
                    <Package size={12} className="text-[#2E7D32]" /> Warehouse
                    Manager
                  </p>
                </div>
                <button
              ...
              <div className="flex-grow overflow-auto p-4 sm:p-8 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 bg-white">
                ...
                <div className="space-y-8">
                  <div>
                    <h3 className="text-xs font-black uppercase tracking-widest text-[#B71C1C] mb-4">
                    ...
                    <div className="space-y-3">
                      ...
                      selectedProduct.variants.length > 0 ? (
                        selectedProduct.variants.map((v: any, i: number) => (
                          <div
                            key={i}
                            className={`p-5 rounded-2xl border transition-colors cursor-pointer group focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation ${selectedVariant?.uom === v.uom ? "border-[#2E7D32] bg-[#2E7D32]/5 ring-1 ring-[#2E7D32]/20" : "border-gray-100 hover:border-gray-200 hover:bg-gray-50"}`}
                            onClick={() => {
                          ...
                          >
                            <div className="flex justify-between items-center gap-4">
                              <div className="flex items-center gap-3 min-w-0">
                                <div className="w-8 h-8 rounded-lg bg-white flex items-center justify-center text-[#B71C1C] font-bold text-[10px] sm:text-xs shadow-sm border border-gray-100 shrink-0">
                                  {v.uom.slice(0, 2).toUpperCase()}
                                </div>
                                <div className="min-w-0">
                                  <p className="font-bold text-[#B71C1C] text-sm sm:text-base truncate">
                                    {v.uom}
                                  </p>
                              ...
                              <div className="text-right shrink-0">
                                <span
                                  className={`text-lg sm:text-2xl font-serif font-black tabular-nums ${v.stock <= threshold ? "text-red-500" : "text-[#B71C1C]"}`}
                                >
                                  {v.stock || 0}
                                </span>
                            ...
                            {selectedVariant?.uom === v.uom && (
                              <motion.div
                                ...
                                className="pt-4 mt-4 border-t border-[#2E7D32]/10 flex gap-3"
                              >
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                  ...
                                  className="flex-1 py-2.5 sm:py-3 bg-[#B71C1C] text-white rounded-xl text-[9px] sm:text-xs font-bold uppercase tracking-widest hover:bg-[#8E0000] transition-colors flex justify-center items-center gap-1 sm:gap-2 shadow-lg shadow-[#B71C1C]/20 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation"
                                >
                                  <ArrowDownRight
                                    size={12}
                        ...
                        <div className="p-6 rounded-2xl border border-gray-100 bg-gray-50 text-center">
                          ...
                          <div className="flex gap-4 justify-center">
                            <button
                              ...
                              className="px-6 py-3 bg-[#B71C1C] text-white rounded-xl text-xs font-bold uppercase tracking-widest shadow-lg hover:bg-[#8E0000] transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation"
                            >
                              Manage Stock
                            </button>
                          </div>
                  ...
                  <AnimatePresence>
                    {actionType && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 10 }}
                        className="bg-[#FAF3E0] p-6 rounded-[24px] border border-[#2E7D32]/20 relative overflow-hidden"
                      >
                        <div className="absolute top-0 right-0 p-4 opacity-10">
                          {actionType === "purchase" ? (
                            ...
                            <History size={80} className="text-[#2E7D32]" />
                          )}
                        </div>
                        <h4 className="font-bold text-[#B71C1C] mb-6 flex items-center gap-2 relative z-10">
                          {actionType === "purchase"
                        ...
                        <div className="grid grid-cols-2 gap-4 relative z-10">
                          <div className="col-span-2">
                            <label className="text-[10px] font-bold text-[#B71C1C]/60 uppercase tracking-widest mb-1.5 block">
                              Quantity Change
                            </label>
                            <input
                              type="number"
                              ...
                              placeholder="0"
                              className={`w-full bg-white p-3 sm:p-4 rounded-xl shadow-sm text-base sm:text-lg font-bold text-[#B71C1C] outline-none transition-shadow font-serif focus-visible:ring-2 focus-visible:ring-[#2E7D32]/50 touch-manipulation tabular-nums ${fieldErrors.quantity ? "ring-2 ring-red-300" : ""}`}
                            />
                          ...
                          {actionType === "purchase" ? (
                            <>
                              <div>
                                ...
                                <input
                                  ...
                                  placeholder="0.00"
                                  className={`w-full bg-white p-3 rounded-xl border-none outline-none transition-shadow font-bold focus-visible:ring-2 focus-visible:ring-[#2E7D32]/50 touch-manipulation tabular-nums ${fieldErrors.cost ? "ring-2 ring-red-300" : ""}`}
                                />
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className={`w-full bg-white p-3 rounded-xl border-none outline-none transition-shadow font-medium focus-visible:ring-2 focus-visible:ring-[#2E7D32]/50 touch-manipulation ${fieldErrors.supplier ? "ring-2 ring-red-300" : ""}`}
                                />
                            ...
                            <div className="col-span-2">
                              ...
                              <select
                                ...
                                className={`w-full bg-white p-3 rounded-xl outline-none font-medium cursor-pointer transition-shadow focus-visible:ring-2 focus-visible:ring-[#2E7D32]/50 touch-manipulation ${fieldErrors.reason ? "ring-2 ring-red-300" : ""}`}
                              >
                ...
                {/* Right Col: History */}
                <div className="bg-[#F5F5F5] rounded-[1.5rem] sm:rounded-[2rem] p-4 sm:p-8 flex flex-col h-[400px] sm:h-[600px] border border-[#B71C1C]/5">
                  <div className="flex justify-between items-center mb-4 sm:mb-6">
                    <h3 className="text-[10px] sm:text-xs font-black uppercase tracking-widest text-[#B71C1C]">
                      Transaction Log
                    </h3>
                    <div className="p-1.5 sm:p-2 bg-white rounded-lg text-[#2E7D32] shadow-sm">
                  ...
                  <div className="overflow-y-auto space-y-4 flex-grow pr-2 custom-scrollbar">
                    {history.length === 0 ? (
                      ...
                      history.map((tx, idx) => (
                        <div
                          key={idx}
                          className="bg-white p-3 sm:p-5 rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 group hover:border-[#2E7D32]/30 transition-all"
                        >
                          <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                <p className="text-[9px] sm:text-xs font-black text-[#B71C1C] uppercase tracking-wide">
                                  {tx.type}
                                </p>
